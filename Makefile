...
XTENSA_TOOLS_ROOT ?= /Volumes/Crosstool/esp/crosstool-NG/builds/xtensa-lx106-elf/bin

# base directory of the ESP8266 SDK package, absolute
SDK_BASE	?= /Volumes/Crosstool/esp/esp_iot_sdk_v1.2.0
...
$(FW_BASE)/%.bin: $(TARGET_OUT) | $(FW_BASE)
	$(vecho) "FW $(FW_BASE)/"
	$(Q) export PATH=$(XTENSA_TOOLS_ROOT):$(PATH); $(ESPTOOL) elf2image -o $(FW_BASE)/ $(TARGET_OUT)
